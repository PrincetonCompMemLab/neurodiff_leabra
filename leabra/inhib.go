...
import "github.com/PrincetonCompMemLab/neurodiff_leabra/fffb"
...
type InhibParams struct {
	...
	K_point float64 			 `view:"inline" def:".25" desc:"where to put the point between the Kth and K+1 unit. from 0 to 1. .25 is Randy's default, more to the K+1 end"`
	Target_diff float64		`view:"inline" def:".2" desc:"where to put the point between the Kth and K+1 unit. from 0 to 1. .25 is Randy's default, more to the K+1 end"`
}
